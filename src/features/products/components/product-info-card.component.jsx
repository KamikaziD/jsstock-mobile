  ...
  return (
    <>
      <ProductCard
        elevation={5}
        onClick={() => {
          alert(`Barcode: ${barcode} Item: ${item}`);
        }}
        ar
      >
        <TopBadgeView>
        ...
        <InfoView>
          ...
          <InfoText>
            Price: R {price} /kg | Avg Item Weight: {avgWeight}kg | #Items:{" "}
            {itemsProcessed}
          </InfoText>
          <StockBarView>
            <StockBar
              ...
              color={
                ((stockReceived - stockProcessed) / stockReceived).toFixed(2) <
                0.25
                  ? Colors.red500
                  : Colors.blue500
              }
            />
            <InfoText>
              Stock Available: {stockReceived - stockProcessed} of{" "}
              {stockReceived}kg -{" "}
              {(
                ((stockReceived - stockProcessed) / stockReceived) *
                100
              ).toFixed(2)}
              %
            </InfoText>
          ...
          <BottomBadgeView>
            <InfoBadge>
              Available Stock: {stockReceived - stockProcessed}kg
            </InfoBadge>
